...
class StopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post stops_url, params: { stop: { latitude: @stop.latitude, longitude: @stop.longitude, trip_id: @stop.trip_id } }
    end
  ...
  test "should update stop" do
    patch stop_url(@stop), params: { stop: { latitude: @stop.latitude, longitude: @stop.longitude, trip_id: @stop.trip_id } }
